...
class Settings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ShopLoginCubit()..getProfileData(),
      child: BlocConsumer<ShopLoginCubit, ShopLoginState>(
        ...
        builder: (context, state) {
          ...
          if (ShopLoginCubit.get(context).profileData == null) {
            return Center(child: CircularProgressIndicator());
          } else {
            name.text =
                ShopLoginCubit.get(context).profileData!.data!.name.toString();
            email.text =
                ShopLoginCubit.get(context).profileData!.data!.email.toString();
            phone.text =
                ShopLoginCubit.get(context).profileData!.data!.phone.toString();
